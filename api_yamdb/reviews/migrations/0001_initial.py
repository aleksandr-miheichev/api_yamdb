# Generated by Django 2.2.16 on 2022-10-23 23:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[reviews.validators.validate_username], verbose_name='Логин пользователя')),
                ...
                ('role', models.CharField(choices=[('admin', 'Администратор'), ('moderator', 'Модератор'), ('user', 'Пользователь')], default='user', max_length=9, verbose_name='Роль пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(default=1, error_messages={'Ошибка': 'Пожалуйста, поставьте оценку от 1 to 10'}, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)], verbose_name='Оценка')),
